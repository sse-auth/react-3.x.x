...
export const ThemeProvider: React.FC<React.PropsWithChildren<Omit<ThemeProvider, 'children'>>> = ({
  dataRounded,
  dataShade,
  children,
}) => {
  ...
  return (
    <ThemeContext.Provider value={{ theme, dataRounded, dataShade, toggleTheme }}>
      {children}
